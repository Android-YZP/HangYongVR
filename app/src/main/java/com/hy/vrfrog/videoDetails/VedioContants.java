package com.hy.vrfrog.videoDetails;

/**
 * Created by Smith on 2017/6/23.
 */

public class VedioContants {
    public static final int TWO_D_VEDIO = 0;
    public static final int THREE_D_VEDIO = 1;
    public static final int ALL_VIEW_VEDIO = 2;
    public static final int VR_VIEW_VEDIO = 3;
