...
import com.hy.vrfrog.http.responsebean.SearchVideoBean;
import com.hy.vrfrog.ui.SwipeBackActivity;
import com.hy.vrfrog.utils.LocalUtils;
import com.hy.vrfrog.utils.LongLogUtil;
import com.hy.vrfrog.utils.NetUtil;
import com.hy.vrfrog.utils.UIUtils;
import com.hy.vrfrog.main.home.adapters.SearchAdapter;
import com.hy.vrfrog.main.home.adapters.SearchHAdapter;
import com.hy.vrfrog.main.home.adapters.SearchHeadTypeAdapter;
...
import static com.hy.vrfrog.utils.UIUtils.getContext;
...
public class SearchActivity extends SwipeBackActivity {
    ...
    private void initView() {
        mRvsearchvideo = (RecyclerView) findViewById(R.id.rv_search_video);
        mRvsearchhistory = (RecyclerView) findViewById(R.id.rv_search_history);
        mLlsearchresult = (LinearLayout) findViewById(R.id.ll_search_result);
    ...
    private void initHistoryRecyclerView() {
        ...
        if (searchHistorys != null) {
            mSearchHistoryAdapter = new SearchHAdapter(this, searchHistorys);
        ...
        x.http().post(requestParams, new JsonCallBack() {
            ...
            public void onSuccess(String result) {
                ...
                if (searchVideoBean.getCode() == HTTP_SUCCESS) {
                    ...
                    mSearchAdapter = new SearchAdapter(SearchActivity.this, results);
                    setHead(results);
    ...
    private void setHead(List<SearchVideoBean.ResultBean> results) {
        ...
        mSearchHeadTypeAdapter = new SearchHeadTypeAdapter(this, mSearchTopicResult);
