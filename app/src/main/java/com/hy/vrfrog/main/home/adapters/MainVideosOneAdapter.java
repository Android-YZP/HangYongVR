...
public class MainVideosOneAdapter extends RecyclerView.Adapter<MainVideosOneAdapter.ListHolder> {
    ...
    public MainVideosOneAdapter(Activity context, ViewPager mViewpager, List<TopicBean.ResultBeanX.ResultBean> resultBean, int TopicId, int type) {
    ...
    public ListHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (mHeaderView != null && viewType == TYPE_HEADER) {
            return new MainVideosOneAdapter.ListHolder(mHeaderView);
        }
        if (mFooterView != null && viewType == TYPE_FOOTER) {
            return new MainVideosOneAdapter.ListHolder(mFooterView);
        }
        View layout = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_recommend_two_adapter, parent, false);
        return new MainVideosOneAdapter.ListHolder(layout);
    }
