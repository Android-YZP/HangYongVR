 ...
 * 消息列表的Adapter
 */
public class TCChatGiftListAdapter extends BaseAdapter implements AbsListView.OnScrollListener {

    private static String TAG = TCChatGiftListAdapter.class.getSimpleName();
...
//    private boolean mCreateAnimator = false;
    ...
    public TCChatGiftListAdapter(Context context, ListView listview, List<TCChatEntity> objects) {
...
//        }
        ...
        if (position == 0){    //第一个条目给个动画  ,  次数进行放大
