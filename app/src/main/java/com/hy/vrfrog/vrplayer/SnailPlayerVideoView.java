...
import com.hy.vrfrog.vrplayer.utils.LogcatFileManager;
...
public class SnailPlayerVideoView extends SurfaceView implements
    ...
    public void setScale(int scale) {
        ...
        if (mMediaPlayer != null) {
            switch (scale) {
                case PlayActivity.SCALE_05:
                    _scale = 0.5;
                    break;
                case PlayActivity.SCALE_10:
                    _scale = 1.0;
                    break;
                case PlayActivity.SCALE_20:
                    _scale = 2.0;
                    break;
                default:
                    _scale = 1.0;
...
//		getHolder().setFixedSize(mSurfaceWidth, mSurfaceHeight);
	...
	public void stopPlayback() {
		if (mMediaPlayer != null) {
            ...
            mCurrentState = STATE_IDLE;
            mTargetState = STATE_IDLE;
			if ((Boolean) SPUtils.get(mContext,Definition.LOG_SETTING,true))
